...
```bash
npm test              # 111 deterministic Node tests (stub-GL carries the framebuffer proof here)
...
- All 111 deterministic tests, including the stub-GL deterministic framebuffer checkpoint suite
