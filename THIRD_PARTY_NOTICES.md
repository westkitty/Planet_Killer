...
- `src/data/epochs/modernLandMask.js` — a 2-degree categorical land/sea derivative from GSHHG 2.3.6 data. The upstream package states that its GSHHG-derived land/sea/coastline data are distributed under LGPL-3.0-or-later. Retained texts: `docs/resources/licenses/basemap-data-COPYING.txt` and `basemap-data-COPYING-LESSER.txt`.
